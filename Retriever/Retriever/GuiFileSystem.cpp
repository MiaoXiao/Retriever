...
*/
void GuiFileSystem::Close(void* pHandle)
{
	if (!pHandle)
		return;
...
*/
uint32 GuiFileSystem::Read(void* pHandle, uint8* data, uint32 count)
{
	if (!pHandle)
		return 0;
...
*/
uint32 GuiFileSystem::Write(void* pHandle, uint8* data, uint32 count)
{
	if (!pHandle)
		return 0;
...
*/
void GuiFileSystem::Seek(void* pHandle, uint32 offset, Otter::SeekFlag seekFlag)
{
	if (!pHandle)
		return;
...
*/
uint32 GuiFileSystem::Size(void* pHandle)
{
	if (!pHandle)
		return 0;
